			...
			<div id="text">
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="1">
					<tr>
						...
						<td width="75%"><b>Question Name</b></td>
						<td width="15%"><b>Edit | Delete</b></td>											
					</tr>
					<%
					int count = 1;
					List<Question> questions = (List) request.getAttribute("allQuestions");
					if(questions != null)
					{
						...
						%>						
							<tr>
								<td><%=count %></td>								
								<td align="left"><%=question.getName() %></td>
								<td>
									<a href="de.unistuttgart.iste.se.pkv.view/editQuestion.jsp?questionID= <%=question.getID() %>&action=edit">Edit</a> |
									<a href="../deleteQuestion.jsp?questionID= <%=question.getID() %>&action=delete">Delete</a>
								</td>														
							</tr>			
						<%
						count++;
				...
				<br><br>
				<input name="btnAddQuestion" value="Add New Question" type="submit" />
			</div>
			</div>
			<!--TYPO3SEARCH_end-->
		</div>
